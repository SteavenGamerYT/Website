...
![](/images/2023/create-bootable-usb-windows-10/media-cration-tool-usb-other-pc_.png)
...
![](/images/2023/create-bootable-usb-windows-10/mct-language-32-64-edtion_.png)
8. Select the “USB flash drive” option to create the bootable USB installation media.
![](/images/2023/create-bootable-usb-windows-10/usb-media-creation-tool-windows-10_2020.png)
...
![](/images/2023/create-bootable-usb-windows-10/rufus-2023-windows-10-iso-download-option.png)
...
![](/images/2023/create-bootable-usb-windows-10/rufus-download-iso-settings-2022-win10.png)
...
![](/images/2023/create-bootable-usb-windows-10/create-windows-10-usb-rufus-2022.png)
